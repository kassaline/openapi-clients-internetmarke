...
/**
 * ChargeWalletResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ChargeWalletResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargeWalletResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shopOrderId'] === null) {
            $invalidProperties[] = "'shopOrderId' can't be null";
        }
        if ((mb_strlen($this->container['shopOrderId']) > 18)) {
            $invalidProperties[] = "invalid value for 'shopOrderId', the character length must be smaller than or equal to 18.";
        }

        if ((mb_strlen($this->container['shopOrderId']) < 1)) {
     ...
     * Sets shopOrderId
     *
     * @param string $shopOrderId The order number in the shop. All characters are allowed except < and &.
     *
     * @return self
     */
    public function setShopOrderId($shopOrderId)
    {
        ...
        if ((mb_strlen($shopOrderId) > 18)) {
            throw new \InvalidArgumentException('invalid length for $shopOrderId when calling ChargeWalletResponse., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($shopOrderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shopOrderId when calling ChargeWalletResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets walletBalance
     *
     * @param int|null $walletBalance The new balance.
     *
     * @return self
     */
