...
class AppShoppingCartPDFPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'positionType' => 'string',
        'position' => '\OpenAPI\Client\Internetmarke\Model\VoucherPosition'
    ];
    ...
    */
     ...
     * Sets productCode
     *
     * @param int $productCode The product code for the selected product, e.g. standard letter, maxi letter etc. The product code can be derived from ProdWS integration or directly taken from the downloadable product price lists (PPLs). The product code must be greater than 0 and the product must be available in the third-party application.
     *
     * @return self
     */
    public function setProductCode($productCode)
    {
        ...
        if (($productCode < 1)) {
            throw new \InvalidArgumentException('invalid value for $productCode when calling AppShoppingCartPDFPosition., must be bigger than or equal to 1.');
        }
     ...
     * Gets position
     *
     * @return \OpenAPI\Client\Internetmarke\Model\VoucherPosition
     */
     ...
     * Sets position
     *
     * @param \OpenAPI\Client\Internetmarke\Model\VoucherPosition $position position
     *
     * @return self
     */
