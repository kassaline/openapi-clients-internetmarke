...
/**
 * ContractProduct Class Doc Comment
 *
 * @category Class
 ...
 */
class ContractProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractProduct';
    ...
    */
     ...
     * Sets productCode
     *
     * @param int|null $productCode The product code.
     *
     * @return self
     */
    public function setProductCode($productCode)
    {
        ...
        if (($productCode < 1)) {
            throw new \InvalidArgumentException('invalid value for $productCode when calling ContractProduct., must be bigger than or equal to 1.');
        }
     ...
     * Sets price
     *
     * @param int|null $price The price of the product in euro cents.
     *
     * @return self
     */
