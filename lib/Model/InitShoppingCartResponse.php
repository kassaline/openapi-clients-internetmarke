...
/**
 * InitShoppingCartResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class InitShoppingCartResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitShoppingCartResponse';
    ...
    */
    ...
    public function setShopOrderId($shopOrderId)
    {
        ...
        if ((mb_strlen($shopOrderId) > 18)) {
            throw new \InvalidArgumentException('invalid length for $shopOrderId when calling InitShoppingCartResponse., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($shopOrderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shopOrderId when calling InitShoppingCartResponse., must be bigger than or equal to 1.');
        }
