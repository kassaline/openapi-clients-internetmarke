...
class Authentication200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $getters = [
        ...
        'showTermsAndConditions' => 'getShowTermsAndConditions',
    ...
    {
        $this->setIfExists('userToken', $data ?? [], null);
        $this->setIfExists('walletBalance', $data ?? [], null);
        $this->setIfExists('showTermsAndConditions', $data ?? [], null);
    ...
    */
     ...
     * Sets userToken
     *
     * @param string|null $userToken The access token / bearer token
     *
     * @return self
     */
    public function setUserToken($userToken)
    {
        if (is_null($userToken)) {
            throw new \InvalidArgumentException('non-nullable userToken cannot be null');
        }
    ...
    /**
     * Gets showTermsAndConditions
     *
     * @return bool|null
     */
    public function getShowTermsAndConditions()
    {
        return $this->container['showTermsAndConditions'];
    }

    /**
     * Sets showTermsAndConditions
     *
     * @param bool|null $showTermsAndConditions TaC
     *
     * @return self
     */
    public function setShowTermsAndConditions($showTermsAndConditions)
    {
        if (is_null($showTermsAndConditions)) {
            throw new \InvalidArgumentException('non-nullable showTermsAndConditions cannot be null');
        }
        $this->container['showTermsAndConditions'] = $showTermsAndConditions;
