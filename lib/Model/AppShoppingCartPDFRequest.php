...
class AppShoppingCartPDFRequest extends AppCheckoutPDFRequest
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['createShippingList']) && !in_array($this->container['createShippingList'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'createShippingList', must be one of '%s'",
                $this->container['createShippingList'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string|null $createShippingList Identifier of which type of shipping list is to be created is to be created: 0: No shipping list 1: Shipping list without addresses / delivery receipt only 2: Shipping list with addresses
     *
     * @return self
     */
    public function setCreateShippingList($createShippingList)
    {
        ...
        $allowedValues = $this->getCreateShippingListAllowableValues();
        if (!in_array($createShippingList, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'createShippingList', must be one of '%s'",
                    $createShippingList,
     ...
     * Sets pageFormatId
     *
     * @param int|null $pageFormatId The ID of the print format. All available formats can be identified by request /app/catalog?types=PAGE_FORMATS
     *
     * @return self
     */
