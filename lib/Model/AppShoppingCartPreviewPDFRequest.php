...
class AppShoppingCartPreviewPDFRequest extends AppCheckoutPDFRequest
{
    ...
    */
    ...
    public function setProductCode($productCode)
    {
        ...
        if (($productCode < 1)) {
            throw new \InvalidArgumentException('invalid value for $productCode when calling AppShoppingCartPreviewPDFRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPageFormatId($pageFormatId)
    {
        ...
        if (($pageFormatId < 1)) {
            throw new \InvalidArgumentException('invalid value for $pageFormatId when calling AppShoppingCartPreviewPDFRequest., must be bigger than or equal to 1.');
        }
