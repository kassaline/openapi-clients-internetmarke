...
class CheckoutShoppingCartPDFAppRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets productCode
     *
     * @param int|null $productCode The internal product code for the selected product, e.g. standard letter, maxi letter etc. The product code must be greater than 0 and the product must be available in the third-party application.
     *
     * @return self
     */
    public function setProductCode($productCode)
    {
        ...
        if (($productCode < 1)) {
            throw new \InvalidArgumentException('invalid value for $productCode when calling CheckoutShoppingCartPDFAppRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPageFormatId($pageFormatId)
    {
        ...
        if (($pageFormatId < 1)) {
            throw new \InvalidArgumentException('invalid value for $pageFormatId when calling CheckoutShoppingCartPDFAppRequest., must be bigger than or equal to 1.');
        }
