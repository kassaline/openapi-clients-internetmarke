...
/**
     ...
     * @throws \OpenAPI\Client\Internetmarke\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Internetmarke\Model\CheckoutShoppingCartAppResponse|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error401Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error429Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus
     */
     ...
     * @throws \OpenAPI\Client\Internetmarke\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Internetmarke\Model\CheckoutShoppingCartAppResponse|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error401Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error429Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\Internetmarke\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error401Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error429Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus
     */
     ...
     * @throws \OpenAPI\Client\Internetmarke\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error401Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\RequestStatus|\OpenAPI\Client\Internetmarke\Model\Error429Response|\OpenAPI\Client\Internetmarke\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveCatalogAppWithHttpInfo($types, string $contentType = self::contentTypes['retrieveCatalogApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Internetmarke\Model\RetrieveCatalogResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
