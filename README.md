...
*AppResourceApi* | [**retrieveGalleryApp**](docs/Api/AppResourceApi.md#retrievegalleryapp) | **GET** /app/gallery | Retrieve galleries.
...
- [GalleryItem](docs/Model/GalleryItem.md)
...
- [PrivateGallery](docs/Model/PrivateGallery.md)
- [PublicGallery](docs/Model/PublicGallery.md)
...
- [RetrieveGalleryResponse](docs/Model/RetrieveGalleryResponse.md)
